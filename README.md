...
Just run `./joplinexport`, it will read the database and create a site like this one.
The site itself is published by Cloudflare Pages, which builds from this repository on GitHub.
